...
# Preconditioning dataset size
# examples_10 = examples[:10]     # For training purpose; reducing the number of dataset
# num_01 = len(examples_10)

examples_5 = examples[:5]     # For training purpose; reducing the number of dataset
num_01 = len(examples_5)

trues_list = []
preds_list = []
str = ' '
# num_01 = len(examples)    # Comment if test dataset being used only 10 | Uncomment if all
num_point = 0
start = time.time()
...
print("This is the f1 score: ",results["f1"])
